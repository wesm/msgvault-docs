...
<img src="/tui-senders.svg" alt="msgvault TUI showing the Senders view" style="width: 100%; max-width: 960px; margin: 0 auto 1.5rem; display: block; border-radius: 8px;" />
