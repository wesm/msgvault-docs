...
There are a number of known issues running msgvault on Windows that are being actively worked on. Fixes are expected within the next few days. Thank you for your patience.

If you encounter Windows-specific problems, please [open an issue](https://github.com/wesm/msgvault/issues) so we can track and prioritize the fixes.
