...
From a drill-down view, press `g` to re-aggregate the filtered messages by a different dimension. You can think of this like an interactive pivot table. The cycle skips the dimension you drilled into, so drilling into a sender and pressing `g` cycles through Recipients, Domains, Labels, and Time.

<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
  <Screenshot src="/tui-subgroup-recipients.svg" alt="Sub-grouped by Recipients after drilling into a sender" />
  <Screenshot src="/tui-subgroup-time.svg" alt="Sub-grouped by Time after drilling into a sender" />
</div>
