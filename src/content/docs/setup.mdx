...
If you plan to deploy to a NAS/container, run `msgvault setup` after this step to generate a ready-to-run `nas-bundle` directory containing a containerized deployment and remote configuration.
