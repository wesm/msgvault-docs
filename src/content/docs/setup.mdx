...
Create a `config.toml` file in your msgvault data directory:
...
:::tip
The directory is created automatically the first time you run any msgvault command. If you're unsure of the path, run `msgvault add-account` and the error message will show you the exact location.
:::
